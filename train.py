...
#python3 train.py --name GCN_l1 --dataset minesweeper --model HeToHo --num_layers 1
import torch
...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='minesweeper',
                        choices=['minesweeper', 'tolokers',
                                 'squirrel', 'squirrel-filtered',
                                 'chameleon', 'chameleon-filtered',
                                  'texas', 'texas-4-classes', 'cornell', 'wisconsin'])

    # model architecture
    parser.add_argument('--model', type=str, default='HeToHo',
                        choices=['HeToHo'])
