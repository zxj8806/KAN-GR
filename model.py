...
from modules import (ResidualModuleWrapper, FeedForwardModule,TransformerAttentionSepHeToHoModule)


MODULES = {
    'HeToHo': [TransformerAttentionSepHeToHoModule, FeedForwardModule]
}
